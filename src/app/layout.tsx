...
export const metadata: Metadata = {
  title: "Namaste Chai | Authentic Indian Tea Experience in Jalandhar",  description: "Discover Namaste Chai, a women-owned café serving authentic Indian chai with traditional recipes, fresh ingredients, and genuine warmth. Dine-in, takeaway, and delivery available.",  keywords: "Indian chai, authentic tea, café Jalandhar, women-owned business, chai masala, traditional tea, tea house, cozy café",  metadataBase: new URL("https://namastechai.com"),
  alternates: {
    canonical: "https://namastechai.com"},
  openGraph: {
    title: "Namaste Chai | Authentic Indian Tea Experience",    description: "Experience authentic Indian chai crafted with care and tradition. Visit our women-owned café in Jalandhar.",    url: "https://namastechai.com",    siteName: "Namaste Chai",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/side-view-hand-holding-tea-pot-black-tea-white-cup-around-dry-tea-leaves-white-table_140725-130453.jpg",        alt: "Authentic Indian chai preparation"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Namaste Chai | Authentic Indian Tea Experience",    description: "Experience authentic Indian chai crafted with tradition and care.",    images: ["http://img.b2bpic.net/free-photo/side-view-hand-holding-tea-pot-black-tea-white-cup-around-dry-tea-leaves-white-table_140725-130453.jpg"],
  },
  robots: {
    index: true,
    follow: true,
